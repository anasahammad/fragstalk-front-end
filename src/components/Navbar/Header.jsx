  ...
  return (
    <div className="relative">
      {showBanner && (
        <div className="bg-[#192229] text-white py-2 px-4 text-center relative">
          <span className="text-xs sm:text-sm">
            🎁 GET ₹50 OFF ON EVERY PRODUCTS WITH CODE FRAGSNEW (ONLY FOR NEW
            CUSTOMER).
          </span>
          <button
      ...
      >
          ...
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden lg:flex items-center space-x-4">
                <Link
                  to="https://www.instagram.com/scentzonebd/"
                  target="_blank"
                  className={`${
                    isScrolled ? "text-gray-600" : "text-white"
                  } hover:opacity-75`}
                ...
                <Link
                  to="https://www.facebook.com/scentzone1"
                  target="_blank"
                  className={`${
                    isScrolled ? "text-gray-600" : "text-white"
                  } hover:opacity-75`}
        ...
        <div
        ref={sidebarRef}
  className={`lg:hidden fixed inset-y-0 left-0 w-[70%] bg-[#506364] z-50 transition-transform duration-300 ${
